...
<img src="../img/logo.png" alt="logo" style="width: 128px; padding-right: 80px;">
<div>
<h2 class="align-center">LAPORAN TRANSAKSI LAUNDRY EXORCIST</h2>
...
echo "Pembelian terbanyak jatuh pada paket <b>".$nama_paket ['nama_paket']."</b>";
?></div>
</div>
<!-- algoritma mencari data nama paket yang sering dipilih -->
...
?>
<tr align="right">
<td colspan="3"><b>Total Pemasukan</b>
...
echo "+ Pajak ";
echo "Rp. ".number_format($semua_pajak, 0, ',', '.');
?>
</td>
</tr>
</table>
